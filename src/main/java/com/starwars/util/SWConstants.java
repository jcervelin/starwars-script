...
public class SWConstants {
	...
	public static final String REGEX_22_BLANK_SPACES = "\\W{22}.*";
	public static final String REGEX_10_BLANK_SPACES = "\\W{10}.*";
	...
	public static final String MOVIE_NOT_FOUND = "Movie %1s with id %2s not found";
}